...
// UTILITY MODEL    
    /**
     * Controlla l'esistenza dell'utente ed effettua il set degli attributi
     * della sessione in uso
     *
     * @param username
     * @param password
     *
...
// METODI DI INSERIMENTO NEL DATABASE(OK)
    ...
    /**
     * Aggiunge una pizza nella tabella PIZZE del database e lo aggiunge in
     * lista
     *
     * @param p
     *
...
// METODI DI GET DAL DATABASE(OK)
    ...
    public static ArrayList<Pizza> getListaPizze() throws SQLException {
        ArrayList<Pizza> listaPizze = new ArrayList();
        Connection conn = DBManager.openConnection();
        Statement st = DBManager.openStatement(conn);
        try {
